...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextView = findViewById(R.id.content_main_message);
    ...
    private void sendEmail() {
        ...
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "From Raji");
        emailIntent.putExtra(Intent.EXTRA_TEXT, mMessage);
		//the below line is used to check if there are any available email intents
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_info:
                ...
                Intent infoIndent = new Intent(this, InfoActivity.class);
                startActivity(infoIndent);
                return true;
